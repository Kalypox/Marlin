...
#define STRING_CONFIG_H_AUTHOR "(Jonathan, Marlin)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 800, 800, 3200, 2072.6 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 28, 0, -0.9 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 18  // X point for Z homing
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_BED_SIZE), (Y_BED_SIZE), 5 }
