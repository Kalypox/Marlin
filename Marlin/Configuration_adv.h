...
#define SENSORLESS_BACKOFF_MM  { 10, 10, 0 }  // (linear=mm, rotational=°) Backoff from endstops before sensorless homing
...
#define ENCODER_RATE_MULTIPLIER
  ...
  #define ENCODER_100X_STEPS_PER_SEC  60  // (steps/s) Encoder rate for 100x speed
#endif
...
//
//#define LCD_BACKLIGHT_TIMEOUT 60 // (s) Timeout before turning off the backlight
